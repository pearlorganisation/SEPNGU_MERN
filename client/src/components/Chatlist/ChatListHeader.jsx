...
function ChatListHeader() {
  ...
  return (
    <div className="h-16 px-4 sm:px-3 py-3 flex justify-between items-center bg-white shadow-md">
      {/* Avatar Section */}
      <div className="cursor-pointer">
        <Avtar type="sm" image={userInfo?.profileImage || null} />
      </div>
      ...
      <div className="flex items-center gap-4 sm:gap-2">
        ...
        <Link
          href="/showpdf"
          className="hidden sm:flex items-center rounded-md bg-orange-50 px-3 py-1 text-sm font-medium text-black hover:bg-orange-100 transition"
        >
          Our Course's
        </Link>
        ...
        {/* Chat Icon */}
        <BsFillChatLeftTextFill
          className="text-panel-header-icon cursor-pointer text-xl sm:text-lg"
          title="New Chat"
          onClick={handleAllContactsPage}
        />
