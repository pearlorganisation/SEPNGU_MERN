...
function ChatHeader() {
  ...
  return (
    <div className='h-16 px-4 py-3 flex justify-between items-center bg-panel-header-background z-10'>
        ...
        <Link href="/englishnews" className="w-full max-w-[400px] max-h-[200px] sm:w-[200px] md:w-[200px] lg:w-[250px] items-center rounded-md bg-orange-50 mt-1 px-3 py-0.1 text-sm font-medium text-black-800 ring-1 ring-green-600/20 ring-inset transition hover:bg-orange-100"
        >English News & Games For Learner</Link>
            ...
            <BiSearchAlt2 className='text-panel-header-icon cursor-pointer text-2xl' 
            onClick={()=>dispatch({type:reducerCases.SET_MESSAGE_SEARCH})}/>
            <BsThreeDotsVertical className='text-panel-header-icon cursor-pointer text-2xl'
